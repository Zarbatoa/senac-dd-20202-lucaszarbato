...
public class Constantes {
	...
	public static final String TOTAL_DE_PESSOAS_POR_TIPO = "Todal de Pessoas por Categoria";
	...
	public static final String[] RELATORIO_VACINA_OPCOES = {TOTAL_VACINAS_POR_PESQUISADOR, TOTAL_VACINAS_POR_PAIS_ORIGEM, TOTAL_VACINAS_POR_ESTAGIO_PESQUISA,
			NUMERO_DE_AVALIACOES_POR_VACINA, MEDIA_DE_AVALIACOES_POR_VACINA, TOTAL_DE_PESSOAS_POR_TIPO,
