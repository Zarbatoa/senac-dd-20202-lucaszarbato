...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Pesquisador joao = new Pesquisador(1,-1,ufsc,"João", "Silva", LocalDate.of(1990, 2, 15), 'M', "11111111111");
		PublicoGeral maria = new PublicoGeral(2,-1,"Maria", "Pereira", LocalDate.of(1972, 10, 5),'F', "22222222222",false);
		PublicoGeral jose = new PublicoGeral(3,-1,"José", "Oswaldo", LocalDate.of(1988, 1, 10),'M', "33333333333", true);
