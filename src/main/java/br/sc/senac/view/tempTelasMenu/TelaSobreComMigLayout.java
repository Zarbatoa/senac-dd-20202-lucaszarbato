...
public class TelaSobreComMigLayout extends JFrame {
	 ...
	 */
	public TelaSobreComMigLayout() throws ParseException {
		...
		contentPane.add(lblFiguraPrograma, "cell 1 4");
