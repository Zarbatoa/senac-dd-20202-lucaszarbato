...
public class TelaGerenciamentoDeVacinas extends JPanel {
	...
	public TelaGerenciamentoDeVacinas() throws ParseException {
		...
		this.setLayout(new MigLayout("", "[grow][][grow][24.00][105.00][47.00][grow][][]", "[][][][][][][][][][][][][]"));
		...
		this.add(lblGerenciamentoVacinas, "cell 3 0 3 1,alignx center");
		...
		this.add(tfNomeVacina, "cell 1 2 3 1,growx");
		...
		this.add(lblEstagioPesquisa, "cell 5 2,alignx trailing");
		...
		this.add(cbEstagioPesquisa, "cell 6 2 2 1,growx");
		...
		this.add(btnVoltar, "cell 4 6,alignx center");
		...
		this.add(btnLimpar, "cell 5 6,alignx center");
		...
		this.add(btnExcluir, "cell 2 8,alignx center");
		...
		this.add(btnEditar, "cell 6 6,alignx center");
		...
		this.add(btnPagAnterior, "cell 2 11,alignx center");
		...
		this.add(btnPagProxima, "cell 6 11,alignx center");
		...
		this.add(btnPegarRegistro, "cell 4 12 2 1,alignx center");
	}
